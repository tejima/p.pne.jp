...
//$PHPTHUMB_CONFIG['document_root'] = '/home';
...
$PHPTHUMB_CONFIG['cache_directory'] = '/tmp/phpthumb_cache/';                            // set the cache directory relative to the phpThumb() installation
...
if (phpthumb_functions::version_compare_replacement(phpversion(), '4.3.2', '>=') && !defined('memory_get_usage') && !@ini_get('memory_limit')) {
	...
	$PHPTHUMB_CONFIG['max_source_pixels'] = round(max(intval(ini_get('memory_limit')), intval(get_cfg_var('memory_limit'))) * 1048576 / 3);
	//$PHPTHUMB_CONFIG['max_source_pixels'] = 0;       // no memory limit
...
$PHPTHUMB_CONFIG['output_format']    = 'png'; // default output format ('jpeg', 'png' or 'gif') - thumbnail will be output in this format (if available in your version of GD). This is always overridden by ?f=___ GETstring parameter
...
$PHPTHUMB_CONFIG['output_interlace'] = false;   // if true: interlaced output for GIF/PNG, progressive output for JPEG; if false: non-interlaced for GIF/PNG, baseline for JPEG.
